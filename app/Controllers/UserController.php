...
class UserController extends BaseController
{
    ...
    public function index($request, $response, $args)
    {
        ...
        $subscribe = '<p>
                                                            ...
                                                            <button class="copy-text btn btn-brand-accent" type="button" data-clipboard-text="'.Config::get('baseUrl').'/link/'.$ssr_sub_token.'?mu=0">点击复制地址</button>
                                                        </p>';
        $subscribe_mu = '<p>
                                                            <span class="icon icon-lg">flash_auto</span> 公共端口订阅地址：
                                                            <input type="text" class="input form-control form-control-monospace" name="input1" readonly value="'.Config::get('baseUrl').'/link/'.$ssr_sub_token.'?mu=1" readonly="true">
